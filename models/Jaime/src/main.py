...
# ── Rutas por defecto ─────────────────────────────────────────────────────────
_DEFAULT_WEIGHTS_QR_RUBBER = str(_BASE / "data" / "runs" / "michelin_v1" / "weights" / "best.pt")
_DEFAULT_WEIGHTS_CUT_EDGE  = str(_BASE / "test" / "runs" / "data" / "runs" / "michelin_v3-4" / "weights" / "best.pt")
